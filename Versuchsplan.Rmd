...
```{r}
#f1 ist fuer die Stichprobengroesse des einseitigen t-Test
f1 <- function(x)
{
...
#f2 ist fuer die Stichprobengroesse des zweiseitigen t-Test
f2 <- function(x)
{
...
Plan_2 <- data.frame(Versuchseinheit=0,Papiergroesse= Plan$A,
                     Stiftgroesse=Plan$B, Versuchsleiterin=Plan$D, Reihenfolge=Plan$C)
...
\hhline{=============}
Versuchsleiterin & 2 & 1 & 1 & 2 & 2 & 1 & 2 & 1 & 1 & 1 & 2 & 2\\
\hline
\end{tabular}
\end{table}
